...
class HrReportAttendanceWizard(models.TransientModel):
    ...
    def action_generar_excel(self):
        ...
        worksheet.write(header_row, 3, 'HORAS TRABAJADAS', formato_encabezado)
        worksheet.write(header_row, 4, 'HORAS AL 50%/EXTRA', formato_encabezado)
        worksheet.write(header_row, 5, 'HORAS AL 100%/FERIADOS/SABADOS', formato_encabezado)
