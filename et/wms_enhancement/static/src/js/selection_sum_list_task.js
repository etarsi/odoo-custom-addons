odoo.define('wms_enhancement.selection_sum_list_task', function (require) {
    "use strict";
    ...
    var SelectionSumController = ListController.extend({
        ...
        _computeSelectionSum: function () {
            ...
            this._rpc({
                ...
                method: 'read',
                args: [ids, ['bultos_count']],  // 🔸 campo a sumar
            }).then(function (records) {
                var total1 = 0;

                records.forEach(function (rec) {
                    total1 += rec.bultos_count || 0;   // campo 1
                });
    ...
    viewRegistry.add('selection_sum_list_task', SelectionSumListView);
});
