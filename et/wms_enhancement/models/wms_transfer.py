...
class WMSTransfer(models.Model):
    ...
    # ETIQUETA
    partner_tag_ids = fields.Many2many(string="Etiquetas", comodel_name="res.partner.category", tracking=True, related="partner_id.category_id", store=True, readonly=True)
