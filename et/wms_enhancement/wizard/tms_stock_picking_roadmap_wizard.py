    ...
    def _compute_wms_task_id(self):
        for rec in self:
            if rec.tms_stock_picking_id:
                ...
                rec.industry_id = rec.tms_stock_picking_id.partner_id.industry_id if rec.tms_stock_picking_id.partner_id and rec.tms_stock_picking_id.partner_id.industry_id else False
