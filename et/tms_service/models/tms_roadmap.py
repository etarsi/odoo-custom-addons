...
class TmsRoadmapLine(models.Model):
    ...
    bulto_defendant = fields.Float(string="Bultos Demandados", digits=(16, 2), tracking=True)
    bulto_picking   = fields.Float(string="Bultos Pickeados",  digits=(16, 2), tracking=True)
