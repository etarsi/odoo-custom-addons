            ...
            CREATE OR REPLACE VIEW %s AS (
                ...
                WHERE
                    ...
                    AND (
                        ...
                        AND am.invoice_date >= DATE '2025-01-01'
                        AND am.invoice_date <= DATE '2025-08-31')
                        ...
                        AND am_base.invoice_date >= DATE '2025-01-01'
                        AND am_base.invoice_date <= DATE '2025-08-31')
