# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'web', 'account', 'web_refresher', 'account_check_printing', 'account_payment_group', 'l10n_latam_check', 'l10n_ar', 'l10n_ar_reports','l10n_ar_afipws_fe', 'mail', 'sale', 'product', 'l10n_ar_ux', 'account_financial_report', 'wms_enhancement'],
