...
class ReportResumenStockWizard(models.TransientModel):
    ...
    def action_generar_excel(self):
        ...
        for data in resumen_data.values():
            #ROTACION GENERAL
            if data['unidad_salida'] == 0 or (data['unidad_entrada'] == 0 and data['unidad_inicial'] == 0):
            ...
            # ROTACIÓN
            worksheet_resumen.write_number(row_resumen, 11, 1 if rotacion_remanente >= 1 else rotacion_remanente, fmt_dec2) # Evitar valores mayores a 1 PARA SACAR PORCENTAJE 100%
